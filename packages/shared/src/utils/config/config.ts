...
export const domain_app_ids = {
    'smarttraderstool.com': 68794,
    'deriv.app': 68794,
    'app.deriv.com': 68794,
    'staging-app.deriv.com': 68794,
    'app.deriv.me': 68794,
    'staging-app.deriv.me': 68794,
    'app.deriv.be': 68794,
    'staging-app.deriv.be': 68794,
    'binary.com': 68794,
    'test-app.deriv.com': 68794,
    'royal-app-seven.vercel.app': 68794,
    'star-eight-ruby.vercel.app': 68794,
    'beleiver.vercel.app': 68794,
    'goon-puce.vercel.app': 68794,
};
...
export const getAppId = () => {
    ...
    if (platform && platform_app_ids[platform as keyof typeof platform_app_ids]) {
        ...
        app_id = is_bot ? 68794 : domain_app_ids[current_domain as keyof typeof domain_app_ids] || 68794;
